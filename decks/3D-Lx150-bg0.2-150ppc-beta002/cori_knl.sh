...
RUN_DIR=/global/cscratch1/sd/xiaocan/low_beta_3D/3D-Lx150-bg0.2-150ppc-beta008
...
time srun -n 131072 -N 2048 -c 4 --cpu_bind=cores /tmp/xiaocanli/reconnection.Linux --tpp 4
