...
RUN_DIR=/global/cscratch1/sd/xiaocan/low_beta_3D/2D-Lx150-bg0.2-150ppc-beta01
...
time srun -n 512 -N 8 -c 4 --cpu_bind=cores /tmp/xiaocanli/reconnection.Linux --tpp 4
