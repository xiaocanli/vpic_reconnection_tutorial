                              ...
                              int n_pipeline )
{
  ...
  for( ; nq; nq--, p+=4 )
  {
    ...
    if (etype == 0) { // remove all parallel electric field
      ...
      hay  = qdt_2mc * (ey - eparay);
      haz  = qdt_2mc * ez;
    } else if (etype == 2) { // remove electric field in regions where |E| > |B|
      ...
      hay = merge( outbnd, zeros, eparay ); // zeros for outbnd particles
      haz = merge( outbnd, zeros, eparaz ); // zeros for outbnd particles
    } else if (etype == 3) { // remove perpendicular electric field but keep ExB drift
      hax  = qdt_2mc * eparax;
      hay  = qdt_2mc * eparay;
      haz  = qdt_2mc * eparaz;
    } else {
    ...
    if (etype == 3) { // remove perpendicular electric field but keep ExB drift
