...
begin_initialization {
...
#else
  double vthe    = 0.3;   // Electron thermal speed over c
#endif
  ...
  double taui    = 800.0/(wpe_wce*mi_me); // simulation wci's to run
  ...
  /* double Lx  = 100.0/sqrt(mi_me)*di;   // size of box in x dimension */
  /* double Ly  = ny * Lx / nx;           // size of box in y dimension */
  /* double Lz  = nz * Lx / nx;           // size of box in z dimension */
  ...
  int nz_zone = 1024;           // # of cells / zone along z for energy spectrum diagnostics
