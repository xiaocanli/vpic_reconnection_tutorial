                              ...
                              int n_pipeline )
{
  ...
  const v8float gamma_sironi(args->gamma_sironi);
  const v8float four(4.0);
  const v8float one(1.0);
  const v8float one_half(0.5);
  const v8float one_third(1.0/3.0);
  const v8float one_fourth(0.25);
  const v8float two_fifteenths(2.0/15.0);
  const v8float neg_one(-1.0);
  const v8float zeros(0.0);
  const v8float ten(10.0);
  const v8float one_hundred(100.0);
  ...
  v8float ex, ey, ez;
  v8float eparax, eparay, eparaz, ie2b2, w2, wtmp;
  v8float edotb, etot2, btot2, ib2;
  v8float gamma_scale;
  v8int   ii, outbnd, valid_number;
                              ...
                              int n_pipeline )
{
  ...
  ERROR( ( "No advance_p_efield_pipeline_v8 implementation." ) );
}
