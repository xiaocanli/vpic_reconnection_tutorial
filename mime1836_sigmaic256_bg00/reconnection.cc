...
//
//  Use hdf5_rebase branch of VPIC: https://github.com/lanl/vpic/tree/hdf5_rebase
//
///////////////////////////////////////////////////////////////////////////////
/* #include <H5Part.h> */
#include <math.h>
...
begin_initialization {
  ...
  double wpedt_max = 16.0; // How big a timestep is allowed if Courant is not too restrictive
  ...
  int particle_select = 3000; // track one every particle_select particles
  ...
  double sigmai = 25.6; // Cold ion magnetization
...
# define RANK_TO_INDEX(rank,ix,iy,iz) BEGIN_PRIMITIVE {                 \
  ...
  double nparticles_per_proc = 7*Ne/nproc();
